...
// ReleaseOracle is an Daxxcoin contract to store the current and previous
// versions of the daxxcoreimplementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Daxxcoin user, either
