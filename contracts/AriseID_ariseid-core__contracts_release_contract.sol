...
// ReleaseOracle is an AriseID contract to store the current and previous
// versions of the AriseID implementation. Its goal is to allow Idd to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Idd releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Idd release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an AriseID user, either
