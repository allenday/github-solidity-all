...
// ReleaseOracle is an Trustmachine contract to store the current and previous
// versions of the go-trustmachine implementation. Its goal is to allow Gotrust to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gotrust releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gotrust release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Trustmachine user, either
