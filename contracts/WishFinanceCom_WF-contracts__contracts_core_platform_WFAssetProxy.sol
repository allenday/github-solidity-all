...
import {WFPlatformInterface as WFPlatform} from "./WFPlatformInterface.sol";
import {WFAssetInterface as WFAsset} from "./WFAssetInterface.sol";
import {ERC20Interface as ERC20} from "../erc20/ERC20Interface.sol";

/**
 * @title WF Asset Proxy.
 *
 ...
 * didn't happen yet.
 */
contract WFAssetProxy is ERC20 {

    // Supports WFPlatform ability to return error codes from methods
    uint constant OK = 1;

    // Assigned platform, immutable.
    WFPlatform public bmcPlatform;
     ...
     * @return success.
     */
    function init(WFPlatform _bmcPlatform, string _symbol, string _name) returns(bool) {
     ...
     */
    function _getAsset() internal returns(WFAsset) {
        return WFAsset(getVersionFor(msg.sender));
    }
     ...
     */
    function emitTransfer(address _from, address _to, uint _value) onlyWFPlatform() {
     ...
     */
    function emitApprove(address _from, address _spender, uint _value) onlyWFPlatform() {
