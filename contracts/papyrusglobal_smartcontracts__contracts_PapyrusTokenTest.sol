...
/// @title Test Papyrus Token (tPPR) smart contract.
contract PapyrusTokenTest is StandardToken, Ownable {
  ...
  string public name = "Test Papyrus Token";
  string public symbol = "tPPR";
