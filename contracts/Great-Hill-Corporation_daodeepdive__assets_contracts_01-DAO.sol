...
<contract>contract DAO is Token, TokenCreation {
...
// Modifier that restrict access to certain functions to DAO Token Holders such as vote and create new proposals
...
/// @param _minTokensToCreate Minimum required wei-equivalent tokens to be created for a successful DAO Token Creation
/// @param _closingTime Date (in Unix time) of the end of the DAO Token Creation
/// @param _privateCreation If zero the DAO Token Creation is open to public, a
/// non-zero address means that the DAO Token Creation is only for the address
// This is the constructor: it can not be overloaded so it is commented out
function DAO(address _curator, DAO_Creator _daoCreator, uint _proposalDeposit, uint _minTokensToCreate, uint _closingTime,
	     address _privateCreation) TokenCreation(_minTokensToCreate, _closingTime, _privateCreation) {
curator = _curator;
...
ProposalAdded(_proposalID, _recipient, _amount, _newCurator, _description);
}
