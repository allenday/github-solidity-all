...
<purpose>
/*
 * Token Creation contract, used by the DAO to create its tokens and initialize its ether.
 */
</purpose>
...
// Minimum fueling goal of the token creation, denominated in tokens to be created
...
/// @param _minTokensToCreate Minimum fueling goal in number of tokens to be created
/// @param _closingTime Date (in Unix time) of the end of the Token Creation
/// @param _privateCreation Zero means that the creation is public.  A
/// non-zero address represents the only address that can create Tokens
/// (the address can also create Tokens on behalf of other accounts)
// This is the constructor: it can not be overloaded so it is commented out
function TokenCreation(uint _minTokensToCreate, uint _closingTime, address _privateCreation) {
...
// The number of (base unit) tokens per wei is calculated as `msg.value` * 20 / `divisor`
