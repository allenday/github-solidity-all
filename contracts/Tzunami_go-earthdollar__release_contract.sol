...
// ReleaseOracle is an Earthdollar contract to store the current and previous
// versions of the go-earthdollar implementation. Its goal is to allow Ged to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Earthdollar user, either
